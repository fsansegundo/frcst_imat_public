...
+
+ For this session we recommend [Sections 5.8 to 5.10 of @hyndman2021fpp3](https://otexts.com/fpp3/accuracy.html#accuracy) and the corresponding videos. The code for those sections uses a more advanced R syntax than our lab code, but the results are essentially the same. 
