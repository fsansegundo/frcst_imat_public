...
### Transitioning from R to Python in forecasting:

+ [Hyndman's *Forecasting: Principles and Practice, the Pythonic Way*](https://otexts.com/fpppy/)
+ [Nixtlaverse](https://nixtla.github.io/nixtlaverse/) 
+ [Blog: Data Science with Marco (Peixeiro)](https://www.datasciencewithmarco.com/blog?page=1) including [Time Series Forecasting with SARIMA in Python](https://www.datasciencewithmarco.com/blog/time-series-forecasting-with-sarima-in-python)
